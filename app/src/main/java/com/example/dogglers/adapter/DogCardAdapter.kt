...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val imageView: ImageView = view!!.findViewById(R.id.dog_image_id)
        val textViewDogName: TextView = view!!.findViewById(R.id.dog_name_id)
        val textViewDogAge: TextView = view!!.findViewById(R.id.dog_age_id)
        val textViewDogHobbies: TextView = view!!.findViewById(R.id.dog_hobbies_id)
    }
